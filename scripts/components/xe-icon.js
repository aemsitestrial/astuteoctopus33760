 ...
 *
 * `icon` takes a Font Awesome-style name from ICONS below; `size` is sm, md
 ...
 *
 * Icon path data: Font Awesome Free 6.7.2 (solid) by @fontawesome —
 * https://fontawesome.com, License: CC BY 4.0 (https://fontawesome.com/license/free).
 */

// name -> [viewBox width, viewBox height, path data]
const ICONS = {
